...
public class 随笔索引表 implements Serializable {
    //随笔号 随笔名 标签 第一次编辑时间 最后编辑时间 内容 加密 加密内容 附加值 账号
    //'随笔号' ,'随笔名' ,'标签' ,'第一次编辑时间' ,'最后编辑时间' ,'内容','加密','加密内容','附加值','账号'
    ...
    public 随笔索引表(int 随笔号, String 随笔名, int 标签, Timestamp 第一次编辑时间, Timestamp 最后编辑时间, int 内容, String 加密, String 加密内容, String 附加值, int 账号) {
        this.随笔号 = 随笔号;
        this.随笔名 = 随笔名;
        this.标签 = 标签;
